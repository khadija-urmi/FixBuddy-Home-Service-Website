    ...
    <section className="mt-16 px-4 lg:px-16">
      <div className="flex flex-col md:flex-row items-center gap-16">
        <div className="flex-1 w-full  bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
          ...
          <button
            type="button"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-3/4 text-center"
          >
            Choose Us
          </button>
        </div>
        <div className="flex-1 w-full flex items-center justify-center">
          <Lottie animationData={chooseUsLottie} className="w-2/3" />
        </div>
      </div>
    </section>
  );
