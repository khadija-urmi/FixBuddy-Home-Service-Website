...
const Statistics = () => {
  ...
  return (
    <div className="w-full lg:w-10/12 mx-auto px-4 lg:px-8 py-6 my-16">
      ...
      <div
        className={`w-full mx-auto stats stats-vertical lg:stats-horizontal shadow-lg ${
          darkMode
      ...
      >
        ...
        <div className="stat place-items-center">
          <div className="stat-title text-gray-500">COMPLETED OVER</div>
        ...
        {/* Stat 2 */}
        <div className="stat place-items-center">
          <div className="stat-title text-gray-500">SERVED OVER</div>
          <div className="stat-value text-xl md:text-2xl lg:text-4xl flex justify-center items-center gap-4">
            1900
            <span>
        ...
        {/* Stat 3 */}
        <div className="stat place-items-center">
          <div className="stat-title text-gray-500">MANAGED</div>
          <div className="stat-value text-xl md:text-2xl lg:text-4xl flex justify-center items-center gap-4">
            400+
            <span>
