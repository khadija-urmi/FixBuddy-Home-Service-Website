...
const ServiceDetail = () => {
  ...
  const { serviceName, description, price, imageUrl, provider, serviceArea } =
    singleServiceData;
  ...
  const handlePurchase = async (e) => {
    ...
    axios
      .post("https://home-repair-server.vercel.app/booking", bookingData, {
        headers: {
  ...
  return (
    <div className="card container max-w-3xl mx-auto bg-base-200  my-24 p-4">
      <h2 className="text-2xl font-bold  shadow-2xl mb-6">
        ...
        <form onSubmit={handlePurchase} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              value={serviceName}
              disabled
              className="w-full px-4 py-2 border rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
